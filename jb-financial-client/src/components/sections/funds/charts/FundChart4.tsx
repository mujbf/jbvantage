...
const FundChart4: React.FC<FundChart4Props> = ({}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        `${SERVER_URL}/export-json-credit-opportunity`,
      );
      ...
      const jbCofData = sortedData.map((item: any) => item.JBCOF);
      ...
      setYtdValue(fundYTDData.cofYtdValue);
      setYtdDate(fundYTDData.cofYtdDate);
      setTwelveValue(fundYTDData.cof12mValue);
      setTwelveDate(fundYTDData.cof12mDate);
      setBenchmarkValue(fundYTDData.cofBenchValue);
      setYear1(fundYTDData.cofReturnYear1);
      setYear2(fundYTDData.cofReturnYear2);
      setYear3(fundYTDData.cofReturnYear3);
      setValue1(fundYTDData.cofReturnValue1);
      setValue2(fundYTDData.cofReturnValue2);
      setValue3(fundYTDData.cofReturnValue3);
    };
